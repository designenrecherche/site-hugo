...
bureau: Trésorier
type_page: membres
photo: /dylanfluzin.jpg
etablissement: CNAM - DICEN.IDF
section_cnu: 71 Sciences de l'information et de la communication
titrethese: >-
  Désir de mémoire - Vers un design d'Archive queer(ED.). Expérimentation et
  design critique dans les pratiques contemporaine d’auto-documentation
  numérique LGBTQIA+
titretheseEn: >-
  Desire for Memory – Toward a Queer Archive Design (ED.) Experimentation and
  Critical Design in Contemporary LGBTQIA+ Digital Self-Documentation Practices.
these_start: 2024
these_end: 0
tags:
  - Design critique
  - Archives queer
  - Auto-documentation numérique
  - Mémoire LGBTQIA+
  - Post-numérique
contact:
